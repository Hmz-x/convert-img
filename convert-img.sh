...
# Log file to output random_args generated when --random is passed
# Needs to be generated by privileged user if non-existent on system; must be writable by non-privileged user
log_file="/var/log/convert-img/convert-img.log"
